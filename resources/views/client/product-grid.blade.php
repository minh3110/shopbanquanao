                    ...
                    <div class="sidebar__item">
                        ...
                        <ul>
                            ...
                            @foreach ($categories as $category)
                                <li style="cursor: pointer" onMouseOver="this.style.color='black'"
                                onMouseOut="this.style.color='black'" onclick="filterProductByCate({{ $category->id }}, event);" class="mb-3 brand_item">{{ $category->name }}</li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="sidebar__item">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-5">
                            <div class="filter__sort">
                                ...
                                <select id="sort_price" class="form-control" style="width: 60%">
