                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-center text-150">
                            <span class="text-default-d3">Shop quần áo</span>
                        </div>
                    </div>
                </div>
                <!-- .row -->
                ...
                <div class="row">
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Phương thức thanh toán:</span> {{ $order->payment_method == 0 ? 'Thanh toán cod' : 'Thanh toán online' }}</div>
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
                    ...
                    <div class="text-95 text-secondary-d3">
                        ...
                        @foreach ($orders_detail as $product)
                            <div class="row mb-2 mb-sm-0 py-25">
                                ...
                                <div class="col-9 col-sm-5">{{ $product->name }} (Màu: {{ \App\Models\Color::find($product->color_id)->name }}, Size: {{ \App\Models\Size::find($product->size_id)->name }})</div>
